...
FILES=(
  ...
  "src/seeders/seed_productos_parallel.js"
  "src/seeders/seed_variaciones_parallel.js"
  "src/seeders/seed_facturas_parallel.js"
  "src/seeders/seed_datosfacturas_parallel.js"
  "src/workers/worker_seed_clientes.js"
  "src/workers/worker_seed_productos.js"
  "src/workers/worker_seed_variaciones.js"
  "src/workers/worker_seed_facturas.js"
  "src/workers/worker_seed_datosfacturas.js"
  "Dockerfile"
  "docker-compose.yml"
  "package.json"
)
